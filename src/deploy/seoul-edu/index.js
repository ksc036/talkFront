...
const SOCKET_URL = 'wss://seoul-edu-biz-dev.teespace.com';
const GET_APP_SERVICE_NAME = 'wapl-appstore-biz-dev-2/service.store.getApp';
const UPLOAD_FILE_SERVICE_NAME = 'wapl-appstore-biz-dev-2/UploadObjectService';
const UPDATE_APP_SERVICE_NAME = 'wapl-appstore-biz-dev-2/service.app.UpdateApp';
...
APP_NAME = '톡';
APP_ID = 1;
BUILD_COMMAND = 'yarn build:seoul-edu';
...
if (process.argv[2] === 'desktop') {
  DEVICE_TYPE = 1;
  TITLE_TEXT = ` [서울시교육청 Dev] ${APP_NAME} 앱 업데이트 v0.0.3 - 데스크탑 `;
}
// 모바일
else if (process.argv[2] === 'mobile') {
  DEVICE_TYPE = 2;
  TITLE_TEXT = ` [서울시교육청 Dev] ${APP_NAME} 앱 업데이트 v0.0.3 - 모바일 `;
}
